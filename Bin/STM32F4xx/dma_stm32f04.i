#line 1 "Src\\DMA_STM32F04.cpp"
#line 1 "Src\\DMA_STM32F04.h"
...
#line 2 "Src\\DMA_STM32F04.cpp"
#line 1 "Src\\InterruptManager.h"



#line 5 "Src\\InterruptManager.h"
	...
	, dmaPinMask(mask)
{
	...
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->APB2ENR |= ((uint32_t)0x00000002) | ((uint32_t)0x00004000);
...
inline void DMA_STM32F04::startDMA(uint32_t address)
{
	((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x028))->CR=(7*((uint32_t)0x02000000))|
		...
		((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x028))->M0AR=address;
		((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x028))->CR|=((uint32_t)0x00000001);
